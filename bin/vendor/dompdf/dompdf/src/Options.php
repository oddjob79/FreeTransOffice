...
class Options
{
     ...
     * @var string
     */
//    private $rootDir = '/opt/bitnami/apache2/htdocs/transoffice/dev/bin/vendor/dompdf/dompdf/src/';
	private $rootDir;
     ...
     * @var string
     */
//    private $chroot = '/opt/bitnami/apache2/htdocs/transoffice/dev/reports/';
    private $chroot;
